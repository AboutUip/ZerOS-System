...
| 编号 | 漏洞名称 | 严重程度 | 发现日期 | 提交者 |
|------|---------|---------|---------|--------|
| [CVS-ZEROS-008](CVS_ZEROS_008.md) | FSDirve 未授权远程文件操作漏洞 | 严重 (9.1) | 2026-01-06 | Anixe |
| [CVS-ZEROS-009](CVS_ZEROS_009.md) | ProcessManager 内核 API 调用 PID 欺骗导致权限提升 | 严重 (9.3) | 2026-02-06 | 开发者报告 |
...
- [CVS-ZEROS-008](CVS_ZEROS_008.md): FSDirve 未授权远程文件操作漏洞 ⚠️ (待修复)
- [CVS-ZEROS-009](CVS_ZEROS_009.md): ProcessManager 内核 API 调用 PID 欺骗导致权限提升 ⚠️ (待修复)
