 ...
 * 访问地址: http://localhost:8089/service/module-proxy.php?path=/kernel/dynamicModule/libs/mediapipe/vision_bundle.mjs
 */
...
// service/module-proxy.php 在 service/ 目录下，需要访问项目根目录的文件
// 所以需要向上到项目根目录
// 使用 realpath 确保路径规范化，避免符号链接等问题
$serviceDir = realpath(__DIR__) ?: __DIR__;
$projectRoot = dirname($serviceDir); // 从 service/ 到项目根目录
