...
(function() {
    ...
    const MODULE_DEPENDENCIES = {
        ...
        "../kernel/core/typePool/addressType.js": ["../kernel/core/typePool/enumManager.js"],
        "../kernel/core/typePool/fileType.js": ["../kernel/core/typePool/enumManager.js"],
        
        // 第四层：文件系统模块（依赖 fileType）
        "../kernel/filesystem/fileFramework.js": ["../kernel/core/typePool/fileType.js"],
        "../kernel/filesystem/disk.js": [],
        "../kernel/filesystem/nodeTree.js": ["../kernel/core/typePool/fileType.js"],
        
        // 第五层：内存管理模块（依赖 addressType 和 logLevel）
        "../kernel/memory/heap.js": ["../kernel/core/typePool/logLevel.js", "../kernel/core/typePool/addressType.js"],
        "../kernel/memory/shed.js": ["../kernel/core/typePool/logLevel.js", "../kernel/core/typePool/addressType.js"],
        "../kernel/memory/memoryManager.js": ["../kernel/core/typePool/logLevel.js", "../kernel/memory/heap.js", "../kernel/memory/shed.js"],
        ...
        if (!poolLoaded) {
            waitPromises.push(
                Dependency.waitLoaded("../kernel/core/signal/pool.js", { interval: 10, timeout: 500 })
                    .catch(() => {
                        // 如果超时，再次检查是否已加载
                        if (markAsLoaded("../kernel/core/signal/pool.js")) {
    ...
    async function start_init() {
        try {
            ...
            // 清理过期缓存（在文件系统初始化后执行）
            try {
                if (typeof cleanupExpiredCache === 'function') {
                    await cleanupExpiredCache();
                } else {
                    KernelLogger.debug("BootLoader", "cleanupExpiredCache 函数未定义，跳过清理");
                }
            } catch (e) {
